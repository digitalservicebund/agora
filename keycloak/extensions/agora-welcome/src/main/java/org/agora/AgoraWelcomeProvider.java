	...
	public void onEvent(AdminEvent event, boolean b) {
		...
		if (OperationType.CREATE.equals(event.getOperationType()) && 
			...
			String emailPlainContent = "Hallo " + newUser.getFirstName() + " " + newUser.getLastName() + "," + "\n\n" + 
																 "ein Agora-Konto wurde für Sie angelegt. Der Link ist einen Monat gültig. Sollte der Link nicht mehr gültig sein, wenden Sie sich an die Administrator:innen in Ihrem Gesundheitsamt bzw. Ihrer Organisation." + "\n\n" + 
																 "Um die Registrierung abzuschließen, klicken Sie auf den folgenden Link oder kopieren Sie ihn ggf. in Ihren Browser: " + "\n\n" + 
																 link + "\n\n" +
																 ...
																 "Ihre Amtsleitung hat uns gebeten, die Kollaborationsplattform Agora in Ihrem Gesundheitsamt einzurichten. Agora vereinfacht den internen, regionalen als auch länderübergreifenden Wissensaustausch und die Zusammenarbeit im Öffentlichen Gesundheitsdienst. Weitere Informationen zu Agora finden Sie unter: https://einrichtung.agora-oegd.de/agora?utm_source=registrierungsemail Passwort: kollaboration" + "\n\n" + 
																 "Viele Grüße" + "\n" +
																 "Ihr Agora-Team";

			// String emailHtmlContent = "<h2>Hallo " + newUser.getFirstName() + " " + newUser.getLastName() + ",</h2>" + 
			// 													"<p>ein Agora-Konto wurde für Sie angelegt. Der Link ist einen Monat gültig. Sollte der Link nicht mehr gültig sein, wenden Sie sich an die Administrator:innen in Ihrem Gesundheitsamt bzw. Ihrer Organisation. Um die Registrierung abzuschließen, klicken Sie auf den folgenden Link:</p>" + 
			...
			// 													"Ihre Amtsleitung hat uns gebeten, die Kollaborationsplattform Agora in Ihrem Gesundheitsamt einzurichten. Agora vereinfacht den internen, regionalen als auch länderübergreifenden Wissensaustausch und die Zusammenarbeit im Öffentlichen Gesundheitsdienst. Weitere Informationen zu Agora finden Sie unter: <a href=\"https://einrichtung.agora-oegd.de/agora?utm_source=registrierungsemail\">einrichtung.agora-oegd.de</a> Passwort: <u>kollaboration</u>.</p>" + 
			// 													"<p>Viele Grüße<br />" + 
			// 													"Ihr Agora-Team</p>";
